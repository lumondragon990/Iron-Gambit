...
This repo is the website and nothing else. All internal docs — brand rules, the launch plan, strategy — live in a separate **private** repo. Keep them out of here: anything in a public repo is public.
...
**5. Replace the lookbook tiles.** Six square slots in the Lookbook section.
